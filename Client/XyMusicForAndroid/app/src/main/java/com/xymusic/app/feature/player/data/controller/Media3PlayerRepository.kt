...
): Long = previous.positionDiscontinuitySequence +
    if (
...
internal fun shouldMarkPositionDiscontinuity(commandSucceeded: Boolean, didChangePosition: Boolean): Boolean =
    commandSucceeded && didChangePosition
