...
describe("safe Chinese errors", () => {
  ...
  it("resolves nested OSS proxy URLs against the connected server", () => {
    expect(resolveServerResourceUrls({
      artwork: { url: "/api/v1/assets/00000000-0000-4000-8000-000000000001/cover-version" },
      ...
      artwork: { url: "https://music.example.com/api/v1/assets/00000000-0000-4000-8000-000000000001/cover-version" },
      playback: { url: "https://music.example.com/api/v1/playback/streams/session-1?ticket=abc" },
